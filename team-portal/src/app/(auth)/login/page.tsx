    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-2">Team Portal</h1>
          <p className="text-muted-foreground text-sm">Sign in to your Adrex Media workspace</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              placeholder="you@adrexmedia.com"
            />
          </div>

          <div>
            <label className="block text-sm font-medium mb-1.5" htmlFor="login-password">Password</label>
